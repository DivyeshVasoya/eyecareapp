...
public class dataadpter extends BaseAdapter {
    ...
    public dataadpter(womandata mainActivity, List<Integer> productid, List<String> pType, List<String> image, List<String> longdesc, List<String> pName, List<Integer> pPrice) {
