...
public class mainActivityadpter extends BaseAdapter {
    ...
    public mainActivityadpter(Homepage homepage, List<Integer> productid, List<String> pType, List<String> image, List<String> longdesc, List<String> pName, List<Integer> pPrice) {
        mContext = homepage;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        mylayout= (LinearLayout) inflater.inflate(R.layout.activity_main_activityadpter, null);
