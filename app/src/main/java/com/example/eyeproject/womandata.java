...
public class womandata extends AppCompatActivity {
    String searchName = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_womandata);
        grid=findViewById(R.id.womanGrid);
        Bundle extras = getIntent().getExtras();
        if (extras != null) {
            searchName = extras.getString("data").toLowerCase(Locale.ROOT);
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot zoneSnapshot: dataSnapshot.getChildren()) {
                    String producttype = zoneSnapshot.child("ptype").getValue(String.class).toLowerCase(Locale.ROOT);
                    ...
                    if (producttype.equals(searchName)) {
                        Toast.makeText(womandata.this, searchName, Toast.LENGTH_SHORT).show();
                        productid.add(id);
                        id++;
...
//    }
    ...
    private void setAdapter() {
        dataadpter adapter = new dataadpter(womandata.this,productid,pType,image,longdesc,pName,pPrice);
        ...
        grid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent=new Intent(womandata.this,product.class);
