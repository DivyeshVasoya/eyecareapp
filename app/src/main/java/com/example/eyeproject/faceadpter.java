...
public class faceadpter extends BaseAdapter {
    ...
    public faceadpter(facedata mainActivity, List<Integer> productid, List<String> pType, List<String> image, List<String> longdesc, List<String> pName, List<Integer> pPrice) {
